...
```mermaid
flowchart TD
    ENG["SVARA + TATTVA + TIME + DIRECTION +<br/>POSITION + QUESTION + CONTEXT"]
    ENG --> ACT["ACTION · what should I do?"]
    ENG --> PER["PERSON · what will happen?"]
    ENG --> EVT["EVENT · what is happening?"]
    ACT --> RES["RESULT"]
    PER --> RES
    EVT --> RES
```
...
```mermaid
flowchart LR
    A["What Is Happening Now?"] --> B["Observe Svara"]
    B --> C["Identify Nadi"] --> D["Poorna / Shoonya"] --> E["Tattva"] --> F["Time"] --> G["Direction"] --> H["Context"]
    H --> I["ACTION · Apply"]
    H --> J["QUESTION · Predict"]
    H --> K["PRACTICE · Transform"]
```
...
- [War](06-bhukti-combat.md) — role (invader/defender), direction, tattva, injury sites
- [Conception & Enchantment](07-bhukti-conception.md) — sex-of-child, conception timing, enchantment methods
- [Disease](08-bhukti-disease-prognosis.md) — cause by tattva, prognosis factors
- [Death](09-bhukti-lifespan-prognosis.md) — five prognostic systems (svara pattern, reflection, messenger, bodily signs, shadow)
- [Cosmic Forecast](10-bhukti-weather-agriculture.md) — yearly tattva predictions, weather, harvest
