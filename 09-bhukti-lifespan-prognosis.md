...
Most of these are self-observation methods (observing one's own svara patterns, reflections, bodily signs, and shadow). System 3 (messenger) is relational like [Disease](08-bhukti-disease-prognosis.md), observing external signs to predict a patient's death.
...
```mermaid
flowchart TD
    DEATH["DEATH PROGNOSIS<br/>(self-observation)"]
    DEATH --> S1["System 1: Sustained svara patterns"]
    DEATH --> S2["System 2: Sun reflection in water"]
    DEATH --> S3["System 3: Messenger appearance"]
    DEATH --> S4["System 4: Bodily/sensory signs"]
    DEATH --> S5["System 5: Shadow observation"]
    
    S1 -.->|§328-331| PREVENT["Yogic prevention mentioned"]
    S5 --> PRACTICE["Shadow practice:<br/>mantra + sky-gaze"]
    PRACTICE --> VISION["Vision of Shiva<br/>(color indicates fate)"]
    VISION -.->|§371-374| ESCAPE["Escape through yoga"]
```
