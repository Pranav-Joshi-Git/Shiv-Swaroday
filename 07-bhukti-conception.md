...
```mermaid
flowchart LR
    C["CONCEPTION / ATTRACTION"] --> INPUTS["Man's svara × Woman's svara ×<br/>Timing × Tattva × Day"]
    INPUTS --> OUT1["Conception result"]
    INPUTS --> OUT2["Attraction / influence"]
    OUT1 --> SEX["Sex of child<br/>(conflicting rules)"]
    OUT1 --> CHAR["Character / fate"]
```
...
|---|---|
| **Water** | Wealthy · famous · prosperous · fortunate (§298-299)<br/>**Also:** girl child (§300) |
| **Earth** | Prosperous · brave · virtuous · hedonistic (§298, 300)<br/>Sex not specified |
| **Air** | Melancholy disposition (§298)<br/>Sex not specified |
