...
flowchart TD
    ...
    B --> ENG["Reading the World"]
    ENG --> W["War & Combat"]
    ENG --> C["Conception & enchantment"]
    ENG --> D["Disease Prognosis"]
    ENG --> DE["Death Signs & Prognosis"]
    ENG --> CO["Weather & Agriculture"]

    M --> Y["The yoga path<br/>Pranayama → Sushumna → Samadhi"]
    ...
    click T "/tattvas" "Tattvas — the five elements"
    click PR "/prana-vayus" "Prana & Vayus"
    click N "/nadis" "Nadis — Ida / Sushumna / Pingala"
    click S "/svara" "Svara & Poorna/Shoonya"
    click ENG "/bhukti-reading-the-world" "Reading the World"
    click W "/bhukti-combat" "War & Combat"
    click C "/bhukti-conception" "Conception & enchantment"
    click D "/bhukti-disease-prognosis" "Disease Prognosis"
    click DE "/bhukti-lifespan-prognosis" "Death Signs & Prognosis"
    click CO "/bhukti-weather-agriculture" "Weather & Agriculture"
    click Y "/mukti-yoga" "The yoga path"
    click U "/unifying-view" "Unifying View"
