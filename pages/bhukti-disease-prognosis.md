---
title: Disease Prognosis Through Breath
---
...
```mermaid
flowchart TD
    Q["Question about patient"] --> OBS["Observe at moment of asking"]
    OBS --> ANS["Answerer's svara<br/>(Ida/Pingala/entering direction)"]
    OBS --> QST["Questioner's position<br/>(Poorna/Shoonya side)"]
    OBS --> BEH["Questioner's behavior<br/>(calm/agitated, clear/confused)"]
    OBS --> VIS["Mental visualization<br/>of patient"]
...
- **Self-observation mode:** You observe your own svara patterns over time → irregular flow indicates your own health decline (expanded extensively in [Death](bhukti-lifespan-prognosis.md))
...
This domain shows the svara system applied to **prognosis through relational observation**. Unlike [War](bhukti-combat.md) (one person's svara determines their action timing) or [Conception](bhukti-conception.md) (two partners' svaras interact to create outcome), disease prognosis operates through a **three-party system**: patient (visualized), questioner (physically present), answerer (observing their own svara).
